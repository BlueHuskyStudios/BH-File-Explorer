...
import static org.bh.app.fe.util.MIMEType.STANDARDS_TYPE_APPLICATION;
import static org.bh.app.fe.util.MIMEType.STANDARDS_TYPE_IMAGE;
import static org.bh.app.fe.util.MIMEType.STANDARDS_TYPE_TEXT;
...
public interface CommonMIMETypes
{
	...
	*/
	...
	public static final MIMEType PNG = new I("png");
